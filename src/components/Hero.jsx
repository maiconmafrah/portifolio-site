...
export default function Hero() {
  return (
    <section className="relative w-full overflow-hidden min-h-screen flex flex-col justify-center">
      ...
      <div className="w-full max-w-6xl mx-auto px-4 pt-32 pb-20 z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
        <motion.div 
